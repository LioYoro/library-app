...
function executeAction(id) {
  ...
  fetch("reservation_tab.php", { // Explicit POST URL
    method: "POST",
      ...
      if (data.success) {
        ...
        if (result && resultText) {
          ...
          switch (currentActionType) {
            case "confirm": resultClass = "result-confirmed"; resultMessage = "✓ Confirmed"; break;
            case "cancel": resultClass = "result-cancelled"; resultMessage = "✗ Cancelled"; break;
            case "done": resultClass = "result-done"; resultMessage = "✓ Completed"; break;
          }
...
clearBtn.addEventListener('click', () => {
    statusFilter.value = '';
    typeFilter.value = '';
    filterReservations(); // Show all rows
});
